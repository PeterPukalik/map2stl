...
////{
////    /// <summary>
////    /// Represents a simple 3D mesh with vertices and triangular faces.
////    /// </summary>
...
////        /// <summary>
////        /// Main entry: 
////        /// 1) Load DEM & OSM from GLB
////        /// 2) Cull OSM nodes outside DEM bounding box
////        /// 3) Per-vertex "hug" for in-bounds OSM vertices (downward ray)
////        /// 4) Merge DEM + OSM into single mesh
////        /// 5) Export ASCII STL
////        /// </summary>
...
////            // 2. Compute DEM bounding box
////            var demBox = ComputeModelBoundingBox(demModel);

////            // 3. Extract DEM triangles for ray intersection
////            var demTriangles = ExtractDemTriangles(demModel);

////            // 4. Build merged mesh
////            MeshData merged = new MeshData();

////            // 4A. Merge DEM as-is (no culling)
////            ProcessModelForMerge(demModel, merged, skipOutOfBounds: false, demBox, demTriangles);

////            // 4B. Merge OSM with culling + per-vertex hug
////            ProcessModelForMerge(osmModel, merged, skipOutOfBounds: true, demBox, demTriangles);

////            // 5. Export merged mesh to STL
////            ExportToStl(merged, outputStlPath);

////            Console.WriteLine("Done. STL exported to: " + outputStlPath);
////        }

////        /// <summary>
////        /// Extracts bounding box for entire ModelRoot.
////        /// </summary>
...
////            {
////                var box = ComputeNodeBoundingBox(node);
...
////        /// <summary>
////        /// Extracts bounding box for a single node.
////        /// </summary>
...
////                    {
////                        Vector3 worldPos = Vector3.Transform(pos, node.GetWorldMatrix(null, 0));
...
////        /// <summary>
////        /// Extracts all triangles from the DEM into a list of (v1, v2, v3).
////        /// We'll use this for downward ray intersection.
////        /// </summary>
...
////                    // For convenience, transform on the fly
////                    for (int i = 0; i < indices.Length; i += 3)
////                    {
////                        Vector3 p1 = Vector3.Transform(positions[indices[i]], node.GetWorldMatrix(null, 0));
////                        Vector3 p2 = Vector3.Transform(positions[indices[i + 1]], node.GetWorldMatrix(null, 0));
////                        Vector3 p3 = Vector3.Transform(positions[indices[i + 2]], node.GetWorldMatrix(null, 0));
...
////        /// <summary>
////        /// Merges geometry from a ModelRoot into the "merged" mesh.
////        /// If skipOutOfBounds=true, we skip entire nodes that lie completely outside demBox.
////        /// For in-bounds nodes, we do a per-vertex downward ray to "hug" the DEM.
////        /// </summary>
...
////                // Cull entire node if bounding box doesn't intersect DEM box
...
////                // For each primitive, we extract the positions, do a downward ray for each vertex
////                // to find a DEM intersection, then add to the merged mesh.
////                foreach (var prim in node.Mesh.Primitives)
////                {
////                    var positions = prim.GetVertexAccessor("POSITION").AsVector3Array();
////                    var indices = prim.IndexAccessor.AsIndicesArray();
...
////                        // Raycast downward from a small offset
////                        Vector3 startPos = worldPos + new Vector3(0, 0.1f, 0);
////                        Vector3 dir = new Vector3(0, -1, 0);
////                        float? terrainY = RaycastDownToDem(startPos, dir, demTriangles);
////                        if (terrainY.HasValue)
////                        {
////                            // Move vertex to intersection
////                            worldPos.Y = terrainY.Value;
////                        }
...
////        /// <summary>
////        /// Casts a ray downward, returning the Y of the first intersection with the DEM triangles, or null if no hit.
////        /// </summary>
...
////        /// <summary>
////        /// Basic ray-triangle intersection. Returns true if there's an intersection with parameter t >= 0.
////        /// </summary>
////        private static bool RayTriangleIntersect(Vector3 origin, Vector3 dir, Vector3 v0, Vector3 v1, Vector3 v2, out float t)
////        {
////            t = 0;
////            // Moller–Trumbore or a simpler approach
////            Vector3 edge1 = v1 - v0;
////            Vector3 edge2 = v2 - v0;
...
////        /// <summary>
////        /// Exports the merged mesh data as an ASCII STL file.
////        /// </summary>
////        private static void ExportToStl(MeshData mesh, string outputStlPath)
////        {
////            using (StreamWriter sw = new StreamWriter(outputStlPath))
////            {
